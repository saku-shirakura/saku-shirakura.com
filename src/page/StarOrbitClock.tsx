...
export const StarOrbitClock = () => {
    ...
    return (
        <>
            ...
            <svg width={width} height={height} className="justify-center items-center">
                <g stroke="#5523cc" strokeWidth="2">
                    <path d={`M${getC_XY(0.1, 0).x},${getC_XY(0.1, 0).y} L${getC_XY(0.9, 0).x},${getC_XY(0.9, 0).y}`}/>
                </g>
                <g fill="none" strokeWidth={2} stroke="#230569">
                    {/* 1分  (60秒) */}
